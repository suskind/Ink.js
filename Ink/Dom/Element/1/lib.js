...
Ink.createModule('Ink.Dom.Element', 1, [], function(undefined) {
    ...
    var Element = {
        ...
        */
         ...
         */
        scroll: function(elm) {
            elm = elm ? this.get(elm) : document.body;
            return [
        ...
        /**
         * @function ? Inserts a element immediately before a target element
         * @param {DOMElement} newElm - element to be inserted
         * @param {DOMElement|String} targetElm - key element
         */
        append: function(newElm, targetElm) 
        {
        ...
        fillSelect: function(container, data, skipEmpty, defaultValue) {
            var containerEl = this.get(container);
        ...
        fillRadios: function(insertAfterEl, name, data, skipEmpty, defaultValue, splitEl) {
            var afterEl = this.get(insertAfterEl);
            ...
            if (afterEl) {  
                ...
                this.get(insertAfterEl).appendChild(containerEl);             
            }
        ...
        */
        data: function( selector ){
            ...
            for( prop in attributesElements ){
                ...
                if( ( ("hasOwnProperty" in attributesElements) && !attributesElements.hasOwnProperty(prop) ) || typeof attributesElements[prop] === 'undefined' ){
                    continue;
